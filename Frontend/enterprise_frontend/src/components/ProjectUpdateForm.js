...
<form className="bg-white p-6 rounded-lg shadow-lg w-full max-w-5xl" onSubmit={parentForm.handleSubmit(handleParentSubmit)}>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div>
        ...
        <select {...parentForm.register("Users", { required: true })} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" >
